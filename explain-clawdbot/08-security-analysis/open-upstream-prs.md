...
|------|---------------|----------------|-----------|-------|
| [#1795](https://github.com/openclaw/openclaw/pull/1795) | (unconfigured proxy bypass) | HIGH | MERGED | Fail-secure proxy detection in `isLocalDirectRequest()` at `src/gateway/auth.ts:115-136` |
| [#2016](https://github.com/openclaw/openclaw/pull/2016) | [#2015](https://github.com/openclaw/openclaw/issues/2015) | HIGH | MERGED | `noteSecurityWarnings()` at `src/commands/doctor-security.ts:197` checks gateway bind + auth |
| [#4880](https://github.com/openclaw/openclaw/pull/4880) | (LFI via MEDIA tokens) | HIGH | MERGED | `isValidMedia()` at `src/media/parse.ts:62-96` accepts all path types; LFI guard moved to `assertLocalMediaAllowed()` at `src/web/media.ts:81-138` |
...
| [#8241](https://github.com/openclaw/openclaw/pull/8241) | (Matrix thread isolation) | MEDIUM | MERGED | thread isolation via `resolveMatrixThreadRootId()`/`resolveMatrixThreadRouting()` at `extensions/matrix/src/matrix/monitor/handler.ts:639,640` |
...
| [#9518](https://github.com/openclaw/openclaw/pull/9518) | [#9517](https://github.com/openclaw/openclaw/issues/9517) (HIGH) | HIGH | MERGED | `authorizeCanvasRequest()` at `src/gateway/server/http-auth.ts:57` wraps canvas/A2UI endpoints (was `server-http.ts:124-172` before Mar 3 sync 3) |
...
| [#11093](https://github.com/openclaw/openclaw/pull/11093) | [#10333](https://github.com/openclaw/openclaw/issues/10333) (MEDIUM) | MEDIUM | MERGED | `sanitizeFilename()` at `extensions/bluebubbles/src/attachments.ts:38` strips dangerous chars from Content-Disposition filenames |
