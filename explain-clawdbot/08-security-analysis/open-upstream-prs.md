...
| [#8241](https://github.com/openclaw/openclaw/pull/8241) | (Matrix thread isolation) | MEDIUM | MERGED | thread isolation via `resolveMatrixThreadRootId()`/`resolveMatrixThreadTarget()` at `extensions/matrix/src/matrix/monitor/handler.ts:642-650` |
