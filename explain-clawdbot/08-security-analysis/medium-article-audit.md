...
| 6 | Token field shifting via pipe injection | **Misleading** | Pipe-delimited format exists (`src/gateway/device-auth.ts:24-38`) but tokens are RSA-signed. Modified payload fails signature verification. |
