...
> **Source:** `src/cli/security-cli.ts:45-51`, `src/security/audit.ts:658-742`, `src/security/fix.ts:387-473`, `src/security/audit-extra.sync.ts`, `src/security/audit-extra.async.ts`, `src/security/audit-channel.ts`
>
