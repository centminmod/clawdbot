...
|-----|---------|-------|--------|
| `edf7d6af6` | fix: harden subagent completion announce retries | 4 prod | Reliability |
| `ae3637b23` | test: expand subagent announce completion coverage | 2 test | Testing |
| `c90b09cb0` | feat(agents): support Anthropic 1M context beta header | 4 prod + 1 test + 2 doc | Feature |
