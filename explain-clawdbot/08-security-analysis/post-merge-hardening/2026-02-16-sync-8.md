...
This batch consists primarily of test infrastructure refactoring (19 commits) plus two gateway boot session management improvements. No security-relevant changes to production security controls.
...
All 19 remaining commits are test infrastructure refactors:

| SHA | Message | Files |
|-----|---------|-------|
| c07036e81 | chore: Update deps. | 2 (package.json, pnpm-lock.yaml) |
...
| 4bdb857ec | chore: Use proper pnpm caching in one CI step. | 1 (.github/workflows) |
