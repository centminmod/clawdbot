...
5. Is actively integrated into web search (`src/agents/tools/web-search.ts:1214,1240,1268,1294`), web fetch (`src/agents/tools/web-fetch.ts:250-271`), cron hooks (`src/cron/isolated-agent/run.ts:346-381`), Discord (`src/discord/monitor/message-handler.process.ts:197-203`), and Slack (`src/slack/monitor/room-context.ts:15-19`)
