...
5. Is actively integrated into web search (`src/agents/tools/web-search.ts:1143,1170,1198,1224`), web fetch (`src/agents/tools/web-fetch.ts:250-271`), cron hooks (`src/cron/isolated-agent/run.ts:311-346`), Discord (`src/discord/monitor/message-handler.process.ts:189-197`), and Slack (`src/slack/monitor/room-context.ts:15-19`)
