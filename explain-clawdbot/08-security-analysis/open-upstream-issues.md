...
| [#6021](https://github.com/openclaw/openclaw/issues/6021) | MEDIUM | Timing attack in non-gateway token comparisons | `src/gateway/server-http.ts:247`, `src/infra/node-pairing.ts:277` |
...
**Affected code:** `src/gateway/hooks.ts:176-222` - size limit present, timeout absent.
