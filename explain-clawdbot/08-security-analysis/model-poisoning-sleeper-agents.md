...
- Code ref: `src/agents/models-config.providers.ts:693-701` — Ollama configured as HTTP endpoint
...
| Ollama HTTP endpoint | `src/agents/models-config.providers.ts:693-701` | `http://127.0.0.1:11434/v1` |
