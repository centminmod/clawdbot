...
- Code ref: `src/agents/models-config.providers.ts:749-759` — Ollama configured as HTTP endpoint
...
| Ollama HTTP endpoint | `src/agents/models-config.providers.ts:749-759` | `http://127.0.0.1:11434/v1` |
