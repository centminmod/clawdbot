...
- Code ref: `extensions/ollama/src/defaults.ts:1` — Ollama configured as HTTP endpoint
...
| Ollama HTTP endpoint | `extensions/ollama/src/defaults.ts:1` | `http://127.0.0.1:11434` |
