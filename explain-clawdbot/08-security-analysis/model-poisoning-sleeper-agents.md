...
- Code ref: `src/memory/embeddings.ts:79-80` — default model `hf:ggml-org/embeddinggemma-300m-qat-q8_0-GGUF`
...
| Embedding model default | `src/memory/embeddings.ts:79-80` | Auto-download from HuggingFace (QAT variant) |
| Embedding providers | `src/memory/embeddings.ts:40` | openai/local/gemini/voyage options |
