...
After a successful auth, the gateway checks whether to auto-approve device pairing (`src/gateway/server/ws-connection/handshake-auth-helpers.ts:49-61`):
