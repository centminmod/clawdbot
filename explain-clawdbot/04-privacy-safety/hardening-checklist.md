...
Source: `src/agents/tool-policy.ts:63-80` (profiles + owner-only fallback), `src/agents/tools/gateway-tool.ts:77` (ownerOnly), `src/agents/tools/gateway.ts:147` (least-privilege scopes), `src/gateway/server-methods.ts:102-105` (scope enforcement)
...
Source: `src/config/io.ts:495-538` (audit helpers), `src/config/io.ts:1186-1236` (audit record builder)
...
Source: `src/config/schema.labels.ts:101-102`, `src/config/schema.help.ts:132-134`
