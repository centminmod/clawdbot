...
Source: `src/config/io.ts:629-724` (audit helpers), `src/config/io.ts:2233-2307` (audit record builder)
...
Source: `src/config/schema.labels.ts:105`, `src/config/schema.help.ts:132-134`
