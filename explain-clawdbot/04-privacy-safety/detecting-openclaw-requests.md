...
**Configurable:** Yes — `tools.web.fetch.userAgent` in the config (`src/config/types.tools.ts:539`).
...
**Source:** `extensions/brave/src/brave-web-search-provider.ts:240-241`
```typescript
headers: {
  Accept: "application/json",
...
**Source:** `src/agents/tools/web-search-provider-common.ts:99-104`
```typescript
headers: {
  Accept: "application/json",
