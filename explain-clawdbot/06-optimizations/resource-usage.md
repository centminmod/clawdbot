...
| 14 | **Cron timer loop** — re-arming `setTimeout` for scheduled job processing | `src/cron/service/timer.ts:273` | Low (idle) | Like a clock ticking in the background — minimal CPU unless jobs are firing |
