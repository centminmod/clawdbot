...
- `buildSafeExternalPrompt()` at `src/cron/isolated-agent/run.ts:364` (defined at `src/security/external-content.ts:280`)
- Suspicious pattern detection and logging at `src/cron/isolated-agent/run.ts:350-358`
