...
- `buildSafeExternalPrompt()` at `src/cron/isolated-agent/run.ts:464-475`
- Suspicious pattern detection and logging at `src/cron/isolated-agent/run.ts:453-462`
