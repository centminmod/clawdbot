...
|-----------|-------------|---------------------|
| Network binding | `src/gateway/net.ts:243-292` | Fallback chain with silent 0.0.0.0 fallback |
...
| Security audit | `src/security/audit.ts:1131-1253` | Critical flag detection |
