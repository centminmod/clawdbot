...
Source: `src/agents/tools/gateway-tool.ts:72,188-199` (owner-only + `config.patch` action), `src/agents/tools/gateway.ts:147` (least-privilege scopes), `src/gateway/server-methods.ts:35-62` (scope enforcement)
