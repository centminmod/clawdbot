...
Integration: `src/agents/skills-install.ts:427-449` (install-time scan), `src/security/audit-extra.async.ts:1183-1359` (security audit deep scan)
...
| Security audit deep scan | `src/security/audit-extra.async.ts:1183-1359` | Plugin code safety findings for `--deep` audit |
