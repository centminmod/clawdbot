...
Integration: `src/agents/skills-install.ts:115-131` (install-time scan), `src/security/audit-extra.async.ts:1148-1324` (security audit deep scan)
...
| Security audit deep scan | `src/security/audit-extra.async.ts:1148-1324` | Plugin code safety findings for `--deep` audit |
