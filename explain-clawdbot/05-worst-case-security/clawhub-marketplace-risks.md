...
Integration: `src/agents/skills-install.ts:116-132` (install-time scan), `src/security/audit-extra.async.ts:1150-1325` (security audit deep scan)
...
| Install-time scan integration | `src/agents/skills-install.ts:116-132` | Collects scan warnings during skill install |
