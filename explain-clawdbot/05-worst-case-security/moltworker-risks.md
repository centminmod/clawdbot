...
> **See:** [Prompt Injection Attacks](./prompt-injection-attacks.md) -- 30 examples of how attackers craft these payloads, including data exfiltration techniques relevant to the egress gap below.
